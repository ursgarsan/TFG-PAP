...
datos_prof = pd.read_excel("database/data/infoProfDemo.xlsx", usecols=[0, 1, 2, 3], header=None)
datos_dep = pd.read_excel("database/data/infoDepDemo.xlsx", header=None)
